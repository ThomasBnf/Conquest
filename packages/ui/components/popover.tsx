...
>(({ children, className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex h-8 cursor-pointer items-center gap-2 rounded-lg px-2 text-sm transition-colors hover:bg-muted",
      className,
    )}
    {...props}
  >
