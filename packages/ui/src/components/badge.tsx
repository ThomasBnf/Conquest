...
const badgeVariants = cva(
  "inline-flex items-center justify-center w-fit rounded-md h-6 gap-2 px-1.5 py-0.5 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring",
  {
    variants: {
      variant: {
