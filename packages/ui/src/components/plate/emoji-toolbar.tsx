    ...
    <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Popover.Portal>
        <Popover.Content
          sideOffset={4}
          align="end"
          className="z-[100] rounded-md bg-background"
        >
          {children}
        </Popover.Content>
      </Popover.Portal>
...
export function EmojiPicker({
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-md bg-popover text-popover-foreground",
      ...
      .map(({ id: categoryId }) => {
        ...
        return (
          <div
            ...
            data-id={categoryId}
          >
            <div className="sticky top-0 z-10 bg-background/90 p-1 py-2 font-semibold text-sm backdrop-blur-xs">
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[&::-webkit-scrollbar-thumb]:min-h-11 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-border/50",
      )}
      data-id="scroll"
    >
      <div
