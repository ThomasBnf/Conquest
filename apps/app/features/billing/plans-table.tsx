...
export const PlansTable = ({ period, setPeriod }: Props) => {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex justify-between divide-x overflow-hidden rounded-md border">
        <div className="divide-y bg-sidebar">
          <div className="flex h-[120px] w-[190px] flex-col justify-between p-3">
            <p className="font-medium text-base">Plans</p>
            <p>
              Billing period
              {period === "annually" && (
