...
export const PeriodToggle = ({
  ...
  <div className="flex h-8 w-fit items-center rounded-md border bg-muted p-px transition-all">
    <button
      type="button"
      className={cn(
        "flex h-full items-center gap-2 rounded-sm px-2",
        period === "annually" ? "bg-background" : "text-muted-foreground",
      )}
      onClick={() => setPeriod("annually")}
    >
      <p className="px-1 py-0.5">Annual</p>
    ...
    >
      <p className="px-1 py-0.5">Monthly</p>
    </button>
  </div>
);
