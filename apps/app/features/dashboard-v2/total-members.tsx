  ...
  return (
    <div className="flex flex-col gap-6 rounded-md border p-6 shadow-sm">
      <div className="flex justify-between gap-2">
        <p className="font-semibold text-lg">Total members growth</p>
      ...
      <div className="flex gap-10">
        <div className="space-y-2">
          <p className="text-muted-foreground">Total unique members</p>
          {isLoading ? (
        ...
        <div className="space-y-2">
          <p className="text-muted-foreground">Total members by integration</p>
          <div>
            {sources.map((source) => (
