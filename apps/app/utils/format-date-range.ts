...
// Function to shorten AM/PM in time strings
...
// Function to remove leading zero from time strings
...
// Function to create a time formatter with a specific locale
...
// Interface for date range format options
