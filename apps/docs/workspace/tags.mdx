...
Some community platforms like Discourse or Discord already have tags. For those, we are collecting all the tags when the community is connected and assign them to the dedicated member.
