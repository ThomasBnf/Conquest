...
Edit or delete tags by using the three dots on the right if they are no longer needed.
...
- Go to a member profile and click on **Add tags** on top of the member information.
