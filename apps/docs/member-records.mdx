...
### Tags
Depending on the community platform you connected, Conquest sync community tag and attributes them to each member. Learn how to manage [community tags](/workspace/tags)    .
...
### Mark a member as staff

By default, all members are visible in the members table and dashboard. However, you may want to distinguish people who work at your company to maintain accurate community statistics.

#### How to mark a member as staff?

1. Go to the member profile
2. Click on the actions menu (three dots)
3. Select "Mark as staff"

Once marked as staff, the member will be:
- Hidden from the members table
- Excluded from community statistics
- Still accessible via company profile

<Frame>
    ![Mark as staff](/images/mark-as-staff.gif)
</Frame>
...
The Pulse Logs records and tracks how a member's engagement score (Pulse Score) changes over time. Find out more about the [Pulse Score](/conquest-pulse/pulse-score).
...
On the Slack free plan, we retain all activities beyond Slack’s 90-day limit. Messages and interactions will remain visible in each member's activity feed.
...
Member information can also be added via CSV import and/or manually by creating custom fields in the form of text, number, date, select, or multi-select, directly from the member sidebar.
