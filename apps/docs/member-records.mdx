...
description: 'Once your community is connected, Conquest gathers data to generate member profiles, retrieving all activities from the past 365 days.'
---

## Member table

The default members view ranks all your members according to their Member Level and displays a comprehensive information table that serves as both a reference and leaderboard. Find out more about [Member Level](/member-level).

### Company
Companies are created **based on email domains**, and members are linked to their respective companies.

### Tags
Depending on the community platform you connected, Conquest sync community tag and attributes them to each member. Learn how to manage [community tags](/community-tags).
