...
If you need more information, feel free to contact us, we’d be happy to walk you through the product.
...
Learn more about all our available integrations 

**Connecting multiple platforms**

New members will be created for all new platforms you connect to Conquest. For every members with the same email address, members will be automatically merge. Otherwise, you will need to merge profile manually. Learn more on merge profile
...
Learn more by reading [Syncing Members and Companies records](https://www.notion.so/Syncing-Members-and-Companies-records-1ba490260bee80d18939df345d03dab1?pvs=21)

Next, learn how to set up your workspace
