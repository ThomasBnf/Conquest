...
The Conquest Slack integration enables you to access and manage community data from your workspace. Gain insights into member activities, message history, and shared content, all in one place.
...
* **Messages, replies, reactions in public channels**
...
<Steps>
  ...
  <Step title="Configure Activity Types">
    ...
    <Frame>
      ![Slack activity types](/images/slack/activity-types.png)
    </Frame>
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Why my Slack workspace is not visible?">
    ...
    * Check if the workspace is already connected to Conquest in other workspace
  </Accordion>
</AccordionGroup>
